const _serviceDetailsViewDef={
  _if:"k8s._uiSwitch._curMainTab=='_services'&&k8s._data._curService",
  _tag:"div",
  _after:function(){
      ...
      _items:[
        {
          ...
          _items:[
            ...
            },
            {
              ...
              _items:[
                {
                  _text:"k8s._data._curService._name"
                }
              ]
            },
            {
        ...
        },
        {
          ...
          _dataModel:"k8s._data._curService._content"
        }
      ]
    }    
  ]
